//Данный скетч имеет 5 комбинаций: Ctrl+Z, Ctrl+C, Ctrl+V, Ctrl+A, Win+V. При нажатии клавиш 2 и 3 активируется пятая комбинация.
//This sketch contains 5 combitations: Ctrl+Z, Ctrl+C, Ctrl+V, Ctrl+A, Win+V. When 2nd and 3rd buttons are pressed, 5th combo is activated.
